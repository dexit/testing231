...
export default function MessagesPage() {
	...
	const loadStats = useCallback( () => {
		apiFetch( { path: '/wrm/v1/messages/stats' } )
			.then( ( d ) => setStats( d || {} ) )
			.catch( () => {} );
	}, [] );
	...
	return (
		<div className="wrm-page wrm-messages-page">
			...
			{ eventsFor && (
				<Modal
					title={ `Message #${ eventsFor.id } — event timeline` }
					onRequestClose={ () => setEventsFor( null ) }
					style={ { maxWidth: 640 } }
				>
					{ eventsLoading ? (
						<Spinner />
