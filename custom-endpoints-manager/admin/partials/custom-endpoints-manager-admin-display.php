	...
	<div id="message" class="updated notice is-dismissible">
		<p>
			...
			if ( 'demos_installed' === $display_message ) {
				...
				echo esc_html( sprintf( __( '%d demo microplugins installed successfully.', 'custom-endpoints-manager' ), $count ) );
			}
			?>
		</p>
	</div>
				...
				<td style="white-space:nowrap">
					...
					<label style="font-size:11px">
						...
						<input type="number" name="cem_endpoints[<?php echo esc_attr( $row_i ); ?>][max_attempts]"
							value="<?php echo esc_attr( isset( $endpoint['max_attempts'] ) ? $endpoint['max_attempts'] : 3 ); ?>"
